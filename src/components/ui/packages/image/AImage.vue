<template>
  <div class="a-image" ref="containerRef" :id="imageId" :data-src="src" :style="containerStyles">
    <div class="a-image__pic" :style="picStyles" v-if="!isLoading && !isError"></div>
    <div class="a-image__loading" v-if="isLoading">
      <slot name="loading"></slot>
    </div>
    <div class="a-image__error" v-if="!isLoading && isError">
